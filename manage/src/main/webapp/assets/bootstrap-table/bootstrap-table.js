...
!function ($) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        if (!this.options.showHeader || this.options.cardView) {
            ...
            this.$tableLoading.css('top', 38 + 'px');
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
          this.options.iconSize = "icon-search";
            html = [];
            html.push(
                '<div class="pull-' + this.options.searchAlign + ' search mgr10 select2-search">',
    ...
    BootstrapTable.prototype.resetView = function (params) {
        ...
        if (this.options.cardView) {
            ...
            this.$tableContainer.css('padding-bottom', 0 + 'px');
            return;
        }
        ...
        // Assign the correct sortable arrow
        this.getCaretHtml();
        this.$tableContainer.css('padding-bottom', 25 + 'px');
    };
