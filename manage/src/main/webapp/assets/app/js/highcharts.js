    ...
    getOffset: function () {
      ...
      if (j || a.isLinked) {
        if (m(e, function (b) {
            ...
            if (h === 0 || h === 2 || {1: "left", 3: "right"}[h] === a.labelAlign)S = t(f[b].getLabelSize(), S)
      ...
      if (q && q.text && q.enabled !== !1) {
        if (!a.axisTitle)a.axisTitle = c.text(q.text, 0, 0, q.useHTML).attr({
          zIndex: 7,
          rotation: q.rotation || 0, align: q.textAlign || {low: "left", middle: "center", high: "right"}[q.align]
  ...
  r(Ga.prototype, {
    select: function (a, b) {
      ...
      if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
        ...
        p.r, this.graphic.attr(z(p, g ? {x: c - g, y: d - g, width: 2 * g, height: 2 * g} : {})), k && k.hide(); else {
