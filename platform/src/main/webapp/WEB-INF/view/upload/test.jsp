...
<body>
        ...
        <div class="modal-content identity">
            ...
            <div class="modal-body">
                ...
                <div class="selected-show">
                    <ul>
                        <li><img src="" alt=""/><img src="<%=cssBasePath%>app/img/delete.png" alt="" class="delete"/></li>
                        <li><img src="" alt=""/><img src="<%=cssBasePath%>app/img/delete.png" alt="" class="delete"/></li>
                    </ul>
                </div>
    ...
    <script type="text/javascript" charset="utf-8" src="<%=cssBasePath%>js/base.js"></script>
    <script type="text/javascript" charset="utf-8" src="<%=cssBasePath%>js/qiniu/plupload.full.min.js"></script>
	<script type="text/javascript" charset="utf-8" src="<%=cssBasePath%>js/qiniu/qiniu.min.js"></script>
    <script type="text/javascript">
    var qiniu = new QiniuJsSDK();
    qiniu.uploader({
	    runtimes: 'html5,flash,html4',    //上传模式,依次退化
	    browse_button: 'pickfiles',       //上传选择的点选按钮，**必需**
	    uptoken_url: '<%=cssBasePath%>qiniu/uptoken',            //Ajax请求upToken的Url，**强烈建议设置**（服务端提供）
	    ...
	    flash_swf_url: '<%=cssBasePath%>js/qiniu/Moxie.swf', //引入flash,相对路径
