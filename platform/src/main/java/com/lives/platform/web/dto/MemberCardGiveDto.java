...
public class MemberCardGiveDto {
	...
	public void setGiveIntegralType(String giveIntegralType) {
		this.giveIntegralType = giveIntegralType == null ? null
				: giveIntegralType.trim();
	}
	...
	public void setGiveRechargeType(String giveRechargeType) {
		this.giveRechargeType = giveRechargeType == null ? null
				: giveRechargeType.trim();
	}
	...
	public void setGiveRechargeIntegralType(String giveRechargeIntegralType) {
		this.giveRechargeIntegralType = giveRechargeIntegralType == null ? null
				: giveRechargeIntegralType.trim();
	}
	...
	public void setGiveRechargeIntegralMoney(
			BigDecimal giveRechargeIntegralMoney) {
	...
	public void setGiveConsumptionIntegralType(
			String giveConsumptionIntegralType) {
		this.giveConsumptionIntegralType = giveConsumptionIntegralType == null ? null
				: giveConsumptionIntegralType.trim();
	}
	...
	public void setGiveConsumptionIntegralMoney(
			BigDecimal giveConsumptionIntegralMoney) {
